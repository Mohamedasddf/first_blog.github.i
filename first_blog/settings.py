...
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '127.0.0.1,localhost,first-blog-github-i-bgzv.vercel.app,first-blog-github-i-bgzv-2gbuk2crx-mohamedasddfs-projects.vercel.app').split(',')
