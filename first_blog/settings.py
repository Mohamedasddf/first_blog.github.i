...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'first-blog-github-i-xxjd.vercel.app','first-blog-github-i-xxjd-git-master-mohamedasddfs-projects.vercel.app']
...
DATABASES = {
    'default': {
        ...
        'HOST': os.environ.get('DB_HOST', 'first-blog-github-i-xxjd-git-master-mohamedasddfs-projects.vercel.app','first-blog-github-i-2b1c-git-master-mohamedasddfs-projects.vercel.app'),      # المضيف (عنوان قاعدة البيانات)
